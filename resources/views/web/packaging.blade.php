...
<section class="bg-gray-fix">
    <div class="container pb-5">
        ...
        <div class="row d-md-flex d-none justify-content-between">
            <div class="col-xl-4 col-lg-4 col-md-6 col-12 px-1 mt-4 mt-4 mb-5 pb-5">
                <div class="wrap6">
                    <div class="front6">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-12 px-1 mt-4 mt-4">
                <div class="wrap6">
                    <div class="front6">
                        <div class="card mx-auto">
        ...
        <div class="row d-md-none d-flex">
            <div class="col-12">
                <div class="owl-carousel" id="packaging-type">
                    <!-- ---------------------------------1-------------------------------------------- -->
                    <div class="item">
                        <div class="wrap6">
                            <div class="front6">
